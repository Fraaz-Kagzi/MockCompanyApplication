class TimesheetsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @timesheet.update(timesheet_params)
        format.html { redirect_to @timesheet, notice: "Timesheet was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to timesheets_path, notice: "Timesheet was successfully destroyed.", status: :see_other }
