...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timesheet" do
    assert_difference("Timesheet.count") do
      post timesheets_url, params: { timesheet: { status: @timesheet.status, user_id: @timesheet.user_id, week_start: @timesheet.week_start } }
    end
  ...
  test "should update timesheet" do
    patch timesheet_url(@timesheet), params: { timesheet: { status: @timesheet.status, user_id: @timesheet.user_id, week_start: @timesheet.week_start } }
